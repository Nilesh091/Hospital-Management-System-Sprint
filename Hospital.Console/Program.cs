  ...
  public class Program
  {
    public static void Main(string[] args)
    {
      ...
      */
      ...
      IRepository<Doctor> doctorRepository = new DoctorRpoEF(context);
      IRepository<Patient> patientRepository = new PatientRepoEf(context);
        ...
        try
        {
          switch (choice)
          {
            ...
            case "8":
              ...
              var patientss = patientservice.FindPatientByName(searchName);
              foreach (var patient in patientss)
              {
            ...
            case "9":
              ...
              if (!string.IsNullOrWhiteSpace(newFeeInput))
                existingDoctor.ConsultationFee = Convert.ToInt32(newFeeInput);
